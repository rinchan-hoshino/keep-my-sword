...
<!-- modern-status:1.21 -->
- `1.21`: Implemented Fabric `0.102.0+1.21` against RinLib branch `mc/1.21`; NeoForge skipped for now pending per-version NeoGradle/ModDev wiring; Forge not targeted after 1.20.1.
